...
# Portfolio
##### 안녕하세요.
##### 전자전기공학을 전공하고, 로봇에 관심이 많아 평소에도 열정을 갖고 취미로 로봇개발을 즐겨하는 개발자 구예찬입니다.
...
##### 팀을 이뤄서 다양한 프로젝트를 진행하면서 협력활동에 익숙하며 리더로서 주도적으로 팀원들에게 역할을 배정하고, 일정관리, 프로젝트 관리 역할도 수행한 경험이 있습니다.
##### 딥러닝에 대한 공부를 지속적으로 하며 SLAM 및 강화학습에 적용하는 것을 목표로 공부하고 있습니다.
##### 발전된 세상을 만들기 위해 로봇을 개발하며 회사에 기여하는 인재가 되고 싶습니다.
##### 감사합니다.
